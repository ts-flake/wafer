...
# %% auto 0
__all__ = ['to_device', 'to_detach', 'to_cpu', 'get_device', 'has_children', 'has_params', 'count_params', 'get_actn', 'Callback',
           'DeviceCB', 'BatchXfmCB', 'MetricCB', 'ProgressCB', 'BaseLogCB', 'ClipGradCB', 'LRCB', 'ReduceLROnPlateauCB',
